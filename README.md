...
<p align="center">
  <a href="YOUR_WEBSITE_URL"><b>Project Website</b></a>
  &nbsp;&nbsp;•&nbsp;&nbsp;
  <a href="YOUR_ARXIV_URL"><b>arXiv</b></a>
  &nbsp;&nbsp;•&nbsp;&nbsp;
  <a href="YOUR_SUPPLEMENTARY_URL"><b>Supplementary Material</b></a>
</p>
...
Full figures and extended validation are available on the  
**[project website](YOUR_WEBSITE_URL)**.
...
which admits the exact one-state realization
...
which admits an exact two-state realization.
...
which is evaluated directly from retained history rather than through an exact finite-dimensional exponential realization.
...
The numerical datasets underlying the figures and tables are available from the corresponding author upon reasonable request.
...
**[Download the Supplementary Material](YOUR_SUPPLEMENTARY_URL)**
